...
public class Excel2007WriterImpl {
    ...
    public Excel2007WriterImpl(String sql,TemplateEO curTempalte,List<ColumnDef> colsdef,OutputStream outputStream) {
        this.sql=sql;
        ...
        while (rs.next()) {
            ...
            for (ColumnDef col : this.colsdef) {
                ...
                if(rs.getObject(col.getDbTableCol()) instanceof java.sql.Date){
                    ...
                    cell.setCellValue(rsc.encodeString(rs.getString(col.getDbTableCol()))); 
                }
            }
            ++n;
        }
