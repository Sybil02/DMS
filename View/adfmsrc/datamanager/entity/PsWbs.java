...
public class PsWbs implements Serializable {
    private static final long serialVersionUID = 6913889787048810275L;
    ...
    private String pstrm;
    private String petrm;
    ...
    public void setPstrm(String pstrm) {
        this.pstrm = pstrm;
    }

    public String getPstrm() {
        return pstrm;
    }

    public void setPetrm(String petrm) {
        this.petrm = petrm;
    }

    public String getPetrm() {
        return petrm;
    }
