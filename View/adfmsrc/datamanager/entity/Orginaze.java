...
public class Orginaze implements Serializable {
    private static final long serialVersionUID = -8077142497803941383L;
    ...
    private String zbmdm;
    private String zbmms;
    private String zzrzx;
    private String zsjbm;
    private String zzggw;
    private String zqybz;
    ...
    public void setZjgdm(String zjgdm) {
        this.zjgdm = zjgdm;
    }

    public String getZjgdm() {
        return zjgdm;
    }

    public void setZbmdm(String zbmdm) {
        this.zbmdm = zbmdm;
    }

    public String getZbmdm() {
        return zbmdm;
    }
    ...
    public void setZzrzx(String zzrzx) {
        this.zzrzx = zzrzx;
    }

    public String getZzrzx() {
        return zzrzx;
    }

    public void setZsjbm(String zsjbm) {
        this.zsjbm = zsjbm;
    }

    public String getZsjbm() {
        return zsjbm;
    }

    public void setZzggw(String zzggw) {
        this.zzggw = zzggw;
    }

    public String getZzggw() {
        return zzggw;
    }

    public void setZqybz(String zqybz) {
        this.zqybz = zqybz;
    }

    public String getZqybz() {
        return zqybz;
    }
