...
import org.hexj.excelhandler.writer.XMLEncoder;
 ...
 *
 */
public abstract class QrzAbstractExcel2007Writer {
    ...
    public void createCell(int columnIndex, double value,
                           int cellType) throws IOException {
        sw.createCell(columnIndex, value, cellType);
    }
    ...
    public static class SpreadsheetWriter {
        ...
        public void createCell(int columnIndex, String value,
            ...
            String ref =
                new CellReference(_rownum, columnIndex).formatAsString();
            _out.write("<c r=\"" + ref.replace("$", "") +
                       "\" t=\"inlineStr\"");
            if (styleIndex != -1)
        ...
        public void createCell(int columnIndex, double value,
            ...
            if (styleIndex == 404) {
                ...
                String ref =
                    new CellReference(_rownum, columnIndex).formatAsString();
                _out.write("<c r=\"" + ref.replace("$", "") + "\" t=\"n\"");
                if (styleIndex != -1)
                    _out.write(" s=\"" + styleIndex + "\"");
                _out.write(">");
        ...
        public void createCell(int columnIndex, Calendar value,
                               int styleIndex) throws IOException {
