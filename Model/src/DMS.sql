...
/* Table: quartz                 */
/*********************************/
-- Create DMS_JOB_DETAILS table
create table DMS_JOB_DETAILS
(
  JOB_ID      VARCHAR2(32),
  JOB_TYPE    VARCHAR2(32),
  JOB_OBJECT  VARCHAR2(200),
  JOB_STATUS  VARCHAR2(20),
  CREATED_AT  DATE,
  CREATED_BY  VARCHAR2(32),
  FILE_NAME   VARCHAR2(200),
  JOB_LOG     VARCHAR2(300),
  END_TIME    DATE,
...
--INFA分类表
--INFA_WORKFLOW_CAT(ID,P_ID,CAT_NAME,IDX,LOCALE,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_WORKFLOW_CAT(
ID VARCHAR2(32),
P_ID VARCHAR2(32),
...
--连接WEBSERVICE信息
--INFA_SERVER_INFO(ID,SERVER_ALIAS,PROTOCOL,SERVER_HOST,SERVER_PORT,LOCALE,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_SERVER_INFO(
ID VARCHAR2(32),
SERVER_ALIAS VARCHAR2(100),
PROTOCOL VARCHAR2(10),
SERVER_HOST VARCHAR2(20),
...
--INFA存储库信息
--INFA_REP_INFO(ID,SERVER_ID,REP_DOMAIN,REP_NAME,USER_NAME,PASSWORD,LOCALE,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_REP_INFO(
ID VARCHAR2(32),
SERVER_ID VARCHAR2(32),
REP_DOMAIN VARCHAR2(100),
...
--INFA工作流信息
--INFA_WORKFLOW(ID,CAT_ID,REP_ID,FOLDERNAME,WORKFLOW_NAME,REQUEST_MODE,SERVICE_NAME,LOCALE,IDX,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_WORKFLOW(
ID VARCHAR2(32),
CAT_ID VARCHAR2(32),
REP_ID VARCHAR2(32),
FOLDERNAME VARCHAR2(100),
WORKFLOW_NAME VARCHAR2(100),
REQUEST_MODE VARCHAR2(32),
...
ALTER TABLE INFA_WORKFLOW ADD(WORKFLOW_ALIAS VARCHAR2(100));

--WORKFLOW参数
--INFA_PARAMETER(ID,P_ALIAS,P_NAME,VS_ID,P_SCOPE,LOCALE,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_PARAMETER(
ID VARCHAR2(32),
P_ALIAS VARCHAR2(100),
P_NAME VARCHAR2(100),
VS_ID VARCHAR2(32),
P_SCOPE VARCHAR2(32),
LOCALE     VARCHAR2(10),
...
--INFA权限
--INFA_ROLE_WORKFLOW(ID,ROLE_ID,WORKFLOW_ID,LOCALE,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_ROLE_WORKFLOW(
ID VARCHAR2(32),
ROLE_ID VARCHAR2(32),
...
--WORKFLOW执行状态表
--INFA_WORKFLOW_EXEC(ID,WORKFLOW_ID,PARAMS,EXEC_STATUS,RUN_ID,LOG_TEXT,HAS_EXCEPTION,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_WORKFLOW_EXEC(
ID VARCHAR2(32),
WORKFLOW_ID VARCHAR2(32),
PARAMS VARCHAR2(100),
EXEC_STATUS VARCHAR2(32),
RUN_ID VARCHAR2(32),
LOG_TEXT VARCHAR2(1000),
HAS_EXCEPTION VARCHAR2(10),
CREATED_AT DATE,
UPDATED_AT DATE,
UPDATED_BY VARCHAR2(32),
CREATED_BY VARCHAR2(32)
);
ALTER TABLE INFA_WORKFLOW_EXEC ADD(FINISH_TIME DATE);

--WORKFLOW参数关系表
--INFA_WORKFLOW_PARAM(ID,WORKFLOW_ID,PARAM_ID,IDX,,CREATED_AT,CREATED_BY,UPDATED_AT,UPDATED_BY)
CREATE TABLE INFA_WORKFLOW_PARAM(
ID VARCHAR2(32),
WORKFLOW_ID VARCHAR2(32),
PARAMS_ID VARCHAR2(32),
LOCALE     VARCHAR2(10),
IDX        NUMBER,
CREATED_AT DATE,
UPDATED_AT DATE,
...
--ROLE VIEW
CREATE OR REPLACE VIEW INFA_USER_WORKFLOW_V AS
SELECT DISTINCT UG.USER_ID, RS.WORKFLOW_ID
  FROM INFA_ROLE_WORKFLOW RS,
       DMS_GROUP_ROLE   GR,
       DMS_USER_GROUP   UG,
       DMS_GROUP        GRP,
       DMS_ROLE         RL
...
-- Create table
create table DMS_TEMPLATE_TIMER
(
  ID           VARCHAR2(32),
  TEMP_ID      VARCHAR2(32),
  TIMER_CRON   VARCHAR2(100),
  MAIL_CONTENT VARCHAR2(1000),
  JOB_NAME     VARCHAR2(40),
  LOCALE       VARCHAR2(32)
);

ALTER TABLE DMS_VALUE_SET ADD DISPLAY_LENGTH NUMBER;