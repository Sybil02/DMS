...
public class InfaModuleImpl extends ApplicationModuleImpl {
    ...
    /**
     * Container's getter for InfaRoleWorkflowVO.
     * @return InfaRoleWorkflowVO
     */
    public ViewObjectImpl getInfaRoleWorkflowVO() {
        return (ViewObjectImpl)findViewObject("InfaRoleWorkflowVO");
    }

    /**
     * Container's getter for InfaRoleWorkLink.
     * @return InfaRoleWorkLink
     */
    public ViewLinkImpl getInfaRoleWorkLink() {
        return (ViewLinkImpl)findViewLink("InfaRoleWorkLink");
    }

    /**
     * Container's getter for InfaUnauthedWorkflowVO.
     * @return InfaUnauthedWorkflowVO
     */
    public ViewObjectImpl getInfaUnauthedWorkflowVO() {
        return (ViewObjectImpl)findViewObject("InfaUnauthedWorkflowVO");
    }
}
