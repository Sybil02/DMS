...
public class DcmTemplateImpl extends DmsEntityImpl {
    ...
    protected void prepareForDML(int operation,
        ...
        if (operation==DML_UPDATE||operation==DML_INSERT){
           this.setDbTable(this.getDbTable()==null ? "" : this.getDbTable().toUpperCase());
           this.setPreProgram(this.getPreProgram()==null ? "" : this.getPreProgram().toUpperCase());
           this.setHandleProgram(this.getHandleProgram()==null ? "" : this.getHandleProgram().toUpperCase());
           this.setAfterProgram(this.getAfterProgram()==null ? "" : this.getAfterProgram().toUpperCase());
           this.setTmpTable(this.getTmpTable()==null ? "": this.getTmpTable().toUpperCase());
        }
    }
