...
// ---    Tue Nov 25 09:20:11 CST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class DcmValidationImpl extends DmsEntityImpl {
    ...
    public enum AttributesEnum {
        Id {
            public Object get(DcmValidationImpl obj) {
                return obj.getId();
            }

            public void put(DcmValidationImpl obj, Object value) {
        ...
        public abstract Object get(DcmValidationImpl object);

        public abstract void put(DcmValidationImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("team.epm.dcm.model.DcmValidation");
        }
    ...
    protected void prepareForDML(int operation,
        ...
        if (operation==DML_UPDATE||operation==DML_INSERT){
            this.setProgram(this.getProgram()==null ? "" : this.getProgram().toUpperCase());
        }
    }
     ...
     * @param value value to set the Program
     */
