...
public class DcmErrorImpl extends DmsEntityImpl {
    ...
    /**
     * @param sheetName key constituent
     * @param rowNum key constituent
     * @param locale key constituent
     * @param validationId key constituent
     * @param templateId key constituent
     * @param comRecordId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String sheetName, Number rowNum,
                                       String locale, String validationId,
                                       String templateId, String comRecordId) {
        return new Key(new Object[]{sheetName, rowNum, locale, validationId, templateId, comRecordId});
    }
