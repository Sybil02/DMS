...
// ---    Thu Oct 23 17:02:05 CST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class DmsGroupRoleImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        Id {
            public Object get(DmsGroupRoleImpl obj) {
                return obj.getId();
            }

            public void put(DmsGroupRoleImpl obj, Object value) {
        ...
        GropId {
            public Object get(DmsGroupRoleImpl obj) {
                return obj.getGropId();
            }

            public void put(DmsGroupRoleImpl obj, Object value) {
                obj.setGropId((String)value);
            }
        }
        ,
        RoleId {
        ...
        public abstract Object get(DmsGroupRoleImpl object);

        public abstract void put(DmsGroupRoleImpl object, Object value);
    ...
    public static final int GROPID = AttributesEnum.GropId.index();
    ...
    /**
     * Gets the attribute value for GropId, using the alias name GropId.
     * @return the GropId
     */
    public String getGropId() {
        return (String)getAttributeInternal(GROPID);
    }

    /**
     * Sets <code>value</code> as the attribute value for GropId.
     * @param value value to set the GropId
     */
    public void setGropId(String value) {
        setAttributeInternal(GROPID, value);
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("team.epm.dms.model.DmsGroupRole");
        }
